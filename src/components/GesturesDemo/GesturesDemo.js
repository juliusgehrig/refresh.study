...
const Screen = Keyframes.Spring({
	...
	swipeUp: { to: { r: 26, g: 27, b: 32 } },
	swipeDown: { to: { r: 26, g: 27, b: 32 } },
	swipeRight: { from: { r: 26, g: 27, b: 32 }, to: { r: 235, g: 236, b: 242 } },
	swipeLeft: { to: { r: 26, g: 27, b: 32 } }
})
...
const Search = Keyframes.Spring({
	...
	swipeUp: { to: { r: 48, g: 50, b: 58 } },
	swipeDown: { to: { r: 48, g: 50, b: 58 } },
	swipeRight: { from: { r: 48, g: 50, b: 58 }, to: { r: 207, g: 214, b: 221 } },
	swipeLeft: { to: { r: 48, g: 50, b: 58 } }
})
...
const Spaces = Keyframes.Spring({
	...
	swipeUp: { from: { x: 0, y: 0, opacitySpace1: 1, opacitySpace2: 0, opacityHistory: 0 }, to: { x: 0, y: -408, opacitySpace1: 0, opacitySpace2: 1, opacityHistory: 0 } },
	swipeRight: { from: { x: 0, y: -408, opacitySpace1: 0, opacitySpace2: 1, opacityHistory: 0 }, to: { x: 625, y: -408, opacitySpace1: 0, opacitySpace2: 0, opacityHistory: 1 } },
	swipeLeft: { to: { x: 0, y: -408, opacitySpace1: 0, opacitySpace2: 1, opacityHistory: 0 } },
	swipeDown: { to: { y: 0, opacitySpace1: 1, opacitySpace2: 0, opacityHistory: 0 } }
})
...
const SpaceDot = Keyframes.Spring({
	...
	swipeUp: { from: { r: 0, g: 122, b: 255 }, to: { r: 255, g: 45, b: 85 } },
	swipeDown: { to: { r: 0, g: 122, b: 255 } }
})
...
const Indicator = Keyframes.Spring({
	...
	swipeUp: { to: { r: 207, g: 212, b: 216 } },
	swipeRight: { to: { r: 132, g: 136, b: 147, x: 585, w: 50 } },
	swipeLeft: { to: { r: 207, g: 212, b: 216, x: 645, w: 40 } },
	swipeDown: { to: { r: 207, g: 212, b: 216 } }
})
...
const SpaceTitle = Keyframes.Spring({
	...
	swipeUp: { from: { r: 224, g: 227, b: 241, width: 73, actions: 202 }, to: { r: 224, g: 227, b: 241, width: 103, actions: 232 } },
	swipeRight: { from: { r: 224, g: 227, b: 241, width: 73, actions: 202 }, to: { r: 65, g: 68, b: 79, width: 103, actions: 232 } },
	swipeLeft: { from: { r: 224, g: 227, b: 241, width: 73, actions: 202 }, to: { r: 224, g: 227, b: 241, width: 103, actions: 232 } },
	swipeDown: { to: { r: 224, g: 227, b: 241, width: 73, actions: 202 } }
