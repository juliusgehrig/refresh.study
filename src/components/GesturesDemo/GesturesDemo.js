...
import { Keyframes, config, interpolate, animated } from 'react-spring'
				        ...
				        <g id="Artboard-3" transform="translate(-261.000000, -214.000000)">
				            <g id="iPad" transform="translate(261.000000, 214.000000)">
				                <g id="iPad_base" fill-rule="nonzero">
				                    ...
				                    <use fill-opacity="0.12" fill="url(#radialGradient-1)" xlinkHref="#path-2"></use>
				                    <use fill="black" fill-opacity="1" filter="url(#filter-3)" xlinkHref="#path-2"></use>
				                </g>
												<Screen native state={this.state.transition}>
													{
														({r,g,b}) =>
				                	<animated.rect id="iPad_screen" stroke="#454A4E" fill={interpolate([r,g,b], (r,g,b) => `rgb(${Math.round(r)},${Math.round(g)},${Math.round(b)})`)} fill-rule="nonzero" stroke-linecap="round" stroke-linejoin="round" x="55.5" y="29.5" width="689" height="519" rx="6"></animated.rect>
													}
												</Screen>
												<Search native state={this.state.transition}>
													{
														({r,g,b}) =>
														<React.Fragment>
					                		<animated.rect id="search" fill={interpolate([r,g,b], (r,g,b) => `rgb(${Math.round(r)},${Math.round(g)},${Math.round(b)})`)} fill-rule="nonzero" x="88" y="99" width="155" height="23" rx="4"></animated.rect>
					                		<animated.rect id="divider" fill={interpolate([r,g,b], (r,g,b) => `rgb(${Math.round(r)},${Math.round(g)},${Math.round(b)})`)} fill-rule="nonzero" x="250" y="120" width="462" height="2" rx="1"></animated.rect>
														</React.Fragment>
													}
												</Search>
												...
												<SpaceTitle native state={this.state.transition}>
													{
														({width,r,g,b}) =>
													<React.Fragment>
														<animated.rect x="122" y="68" width={width} height="15" id="space_title" rx="8" fill={interpolate([r,g,b], (r,g,b) => `rgb(${Math.round(r)},${Math.round(g)},${Math.round(b)})`)} fill-rule="nonzero"></animated.rect>
													</React.Fragment>
													}
												</SpaceTitle>
												<SpaceDot native state={this.state.transition}>
													{
														({r,g,b}) =>
													<React.Fragment>
														<animated.circle id="space_dot_base" fill={interpolate([r,g,b], (r,g,b) => `rgb(${Math.round(r)},${Math.round(g)},${Math.round(b)})`)} fill-rule="nonzero" opacity="0.3" cx="100" cy="75" r="12"></animated.circle>
						                <animated.circle id="space_dot" fill={interpolate([r,g,b], (r,g,b) => `rgb(${Math.round(r)},${Math.round(g)},${Math.round(b)})`)} fill-rule="nonzero" cx="100" cy="75" r="7"></animated.circle>
													</React.Fragment>
													}
												</SpaceDot>
						                    ...
						                    <animated.g id="space_content_1" fill-rule="nonzero" opacity={opacitySpace1}>
						                    ...
						                    <animated.g id="space_content_2" fill-rule="nonzero" opacity={opacitySpace2}>
						                    ...
						                    <animated.g id="space_content_history" opacity={opacityHistory}>
						                        <g transform="translate(-625.000000, 425.000000)">
						                            ...
						                            <g id="Timeline" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(0.000000, 67.000000)">
						                                <rect id="Rectangle-2" fill="#FFFFFF" fill-rule="nonzero" x="70" y="0" width="136" height="26" rx="6"></rect>
						                                <path d="M1,278 L200,278 C203.313708,278 206,280.686292 206,284 L206,298 C206,301.313708 203.313708,304 200,304 L1,304 L1,278 Z" id="Rectangle-2-Copy-20" fill="#FFFFFF" fill-rule="nonzero"></path>
						                                <path d="M577,0 L650,0 L650,26 L577,26 C573.686292,26 571,23.3137085 571,20 L571,6 C571,2.6862915 573.686292,6.08718376e-16 577,0 Z" id="Rectangle-2-Copy-5" fill="#FFFFFF" fill-rule="nonzero"></path>
						                                <path d="M0,48 L103,48 C106.313708,48 109,50.6862915 109,54 L109,68 C109,71.3137085 106.313708,74 103,74 L0,74 L0,48 Z" id="Rectangle-2-Copy" fill="#FFFFFF" fill-rule="nonzero"></path>
						                                <path d="M0,96 L188,96 C191.313708,96 194,98.6862915 194,102 L194,116 C194,119.313708 191.313708,122 188,122 L0,122 L0,96 Z" id="Rectangle-2-Copy-6" fill="#FFFFFF" fill-rule="nonzero"></path>
						                                <rect id="Rectangle-2-Copy-10" fill="#FFFFFF" fill-rule="nonzero" x="404" y="96" width="167" height="26" rx="6"></rect>
						                                <path d="M429,144 L650,144 L650,170 L429,170 C425.686292,170 423,167.313708 423,164 L423,150 C423,146.686292 425.686292,144 429,144 Z" id="Rectangle-2-Copy-11" fill="#FFFFFF" fill-rule="nonzero"></path>
						                                <path d="M131,48 L487,48 C490.865993,48 494,51.1340068 494,55 L494,67 C494,70.8659932 490.865993,74 487,74 L131,74 C127.686292,74 125,71.3137085 125,68 L125,54 C125,50.6862915 127.686292,48 131,48 Z" id="Rectangle-2-Copy-2" fill="#FFFFFF" fill-rule="nonzero"></path>
						                                <path d="M101,144 L380,144 C383.313708,144 386,146.686292 386,150 L386,164 C386,167.313708 383.313708,170 380,170 L101,170 C97.6862915,170 95,167.313708 95,164 L95,150 C95,146.686292 97.6862915,144 101,144 Z" id="Rectangle-2-Copy-9" fill="#FFFFFF" fill-rule="nonzero"></path>
						                                <path d="M233,192 L512,192 C515.313708,192 518,194.686292 518,198 L518,212 C518,215.313708 515.313708,218 512,218 L233,218 C229.686292,218 227,215.313708 227,212 L227,198 C227,194.686292 229.686292,192 233,192 Z" id="Rectangle-2-Copy-14" fill="#FFFFFF" fill-rule="nonzero"></path>
						                                <path d="M173,230 L650,230 L650,256 L173,256 C169.686292,256 167,253.313708 167,250 L167,236 C167,232.686292 169.686292,230 173,230 Z" id="Rectangle-2-Copy-17" fill="#FFFFFF" fill-rule="nonzero"></path>
						                            </g>
												...
												<Cursor native state={this.state.transition}>
													{({opacity,y}) =>
														...
														transform={interpolate([y], y => `translate(333.000000, ${260 + y})`)} fill="#FF9500" fill-rule="nonzero">
												...
												<CursorHorizontal native state={this.state.transition}>
													{({opacity,x}) =>
														...
														transform={interpolate([x], x => `translate(${374 + x}, 219.000000)`)} fill="#FF9500" fill-rule="nonzero" >
																<circle id="Finger_2" cx="26" cy="26" r="26"></circle>
