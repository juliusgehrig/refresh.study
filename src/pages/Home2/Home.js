...
class Home extends Component {
	constructor(props) {
		...
		this.state = {
			spaceSliderPlaying: false
		}
		this.spaceSliderItems = [
			{
			...
			<div styleName="container">
					...
					<Wrapper>
						...
						<div className="row center-xs">
							<div className="col-lg-10">
								<VisibilitySensor delayedCall={true} onChange={visibility => { this.spaceSlider.play(); console.log(this.spaceSlider, visibility) }} />

								<DeviceSlider ref={c => { this.spaceSlider = c }} playing={this.state.spaceSliderPlaying} items={this.spaceSliderItems} />
				...
				<section styleName="section-history">
					<Wrapper>
						...
						<div className="row center-xs">
							<div className="col-lg-10">
								<DeviceSlider items={this.spaceSliderItems} />
							</div>
						</div>
